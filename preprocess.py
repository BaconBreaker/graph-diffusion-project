...
def main(args):
    ...
    val_node_tensor, val_adjecency_tensor, val_pdf_tensor, val_num_particles, \
    test_node_tensor, test_adjecency_tensor, test_pdf_tensor, test_num_particles = train_test_split(node_tensor, adjecency_tensor, pdf_tensor, num_particles)

    #Save the data
    save_data(f'{args.save_dir}/', train_node_tensor, train_adjecency_tensor, train_pdf_tensor, train_num_particles, r, 'train')
    save_data(f'{args.save_dir}/', val_node_tensor, val_adjecency_tensor, val_pdf_tensor, val_num_particles, r, 'val')
    save_data(f'{args.save_dir}/', test_node_tensor, test_adjecency_tensor, test_pdf_tensor, test_num_particles, r, 'test')
