...
def to_dense(x, edge_index, edge_attr, batch):
    ...
    # TODO: breaks the continuous case
...
class MoleculeDatasetInfo(AbstractDatasetInfos):
    def __init__(self, n_nodes, n_node_types, n_edge_types):
