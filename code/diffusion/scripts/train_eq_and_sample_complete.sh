...
python main.py --dataset_path ../../graphs_h5/ --run_name ED_v3 \
	--model self_attention --max_epochs 1000 --check_val_every_n_epoch 1 --batch_size 32 \
...
python ovito_complete_gif.py --dataset_path ../../graphs_h5/ --run_name eq_sample \
	...
	--t_skips 5 --checkpoint_path "checkpoints/ED_v3/last.ckpt" \
